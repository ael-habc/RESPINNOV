...
export default function HistoriqueDemaintenance() {
  ...
  const [Historique2, setHistorique2] = useState([
    ...
    },
    {
        ...
        responsable: "-",
        duree: "45min",
        resultats: "'Suite à la réparation, les alarmes sonores du respirateur d'anesthésie fonctionnaient correctement. Elles étaient audibles et se déclenchaient conformément aux seuils d'alarme définis par le fabricant.",
